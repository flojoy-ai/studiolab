...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                ...
                response_deserializer=protos_dot_hello__pb2.HelloReply.FromString,
                )
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=protos_dot_hello__pb2.HelloReply.SerializeToString,
            ),
...
class Greeter(object):
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/hello.Greeter/SayHello',
            ...
            protos_dot_hello__pb2.HelloReply.FromString,
